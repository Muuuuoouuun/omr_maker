...
describe("backup and restore manifest core", () => {
    it("keeps the exact sorted 39-table backup allowlist aligned with baseline plus migrations", () => {
        ...
        expect(CANONICAL_BACKUP_TABLES).toHaveLength(39);
