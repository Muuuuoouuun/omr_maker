...
const OWNERSHIP = Object.freeze({
    ...
    teacher_core_live_monitor: ["chromium", "e2e/teacher-pages.spec.ts", "screen refresh pause is explicitly scoped and exposes its pressed state"],
    teacher_core_results_feedback: ["chromium", "e2e/teacher-pages.spec.ts", "opens one student result hub and preserves the selected view across attempts"],
