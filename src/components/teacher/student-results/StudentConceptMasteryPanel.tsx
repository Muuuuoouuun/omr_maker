                ...
                <div className={styles.reportGrowthDetails}>
                    {summary.groups.map(group => (
                        <div key={group.concept}>
                            ...
                            <p>{group.trendDelta === null ? "추이 비교에 필요한 기록 또는 응시 순서를 확인할 수 없습니다." : `최근·이전 응시 구간 비교 ${group.trendDelta > 0 ? "+" : ""}${group.trendDelta}%p · 시험 난이도 차이는 반영하지 않습니다.`}</p>
                            <details>
                                <summary>문항 근거 보기</summary>
                                <ul>
