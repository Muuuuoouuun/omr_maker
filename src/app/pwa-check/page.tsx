...
const EXPECTED_OFFLINE_CACHE_PREFIX = "omr-maker-v16";
...
async function readManifestSummary(): Promise<{ detail: string; ok: boolean; value: string }> {
  ...
  try {
    ...
    const hasExpectedOrientation = manifest.orientation === "any";
    ...
    return {
      ...
      ok: hasStandalone && hasExpectedOrientation && hasIcons && hasScreenshots,
