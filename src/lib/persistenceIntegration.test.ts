...
describe("persistence integration", () => {
    ...
    it("primary read screens use the shared persistence layer", () => {
        const screens = [
            ...
            { file: "src/app/student/dashboard/page.tsx", functions: ["loadExams", "loadStudentOfficialAttempts"] },
            { file: "src/app/student/history/page.tsx", functions: ["loadStudentOfficialAttempts"] },
            { file: "src/app/student/review/[attemptId]/page.tsx", functions: ["loadStudentOfficialAttempt"] },
