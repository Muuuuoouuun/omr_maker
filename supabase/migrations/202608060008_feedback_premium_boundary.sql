...
-- Feedback markup and returned feedback are paid entitlements. Keep the plan
-- row locked through the mutation so a concurrent downgrade cannot race the
-- canonical write after the entitlement check.
